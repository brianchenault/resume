    ...
    render: function() {
        return (
            React.createElement("div", {id: "personal"}, 
                ...
                React.createElement("div", {id: "education"}, this.props.data.education), 
                React.createElement("div", {id: "email"}, this.props.data.email), 
                React.createElement("div", {id: "github"}, React.createElement("a", {href: this.props.data.github, target: "_blank"}, this.props.data.github))
            )
        )
    }
});
